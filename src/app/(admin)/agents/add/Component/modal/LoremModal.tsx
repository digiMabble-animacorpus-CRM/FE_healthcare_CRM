...
export default function LoremModal({ isOpen, onClose, title = 'Modal Title', children }: LoremModalProps) {
    ...
    <div className="lorem-modal-overlay">
      <div className="lorem-modal-container">
        <div className="lorem-modal-header">
          <h3>{title}</h3>
          <button onClick={onClose} className="lorem-modal-close">&times;</button>
        </div>
