    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          accordion. To properly achieve the accordion style, be sure to use <code>
            .accordion
          </code>{' '}
          as a wrapper.
        </>
        ...
        {accordionData.map((item, idx) => (
          <AccordionItem eventKey={`${idx}`} key={idx}>
            ...
            <AccordionBody>
              ...
              <code>.accordion-flush</code>&nbsp; class. This is the {item}&nbsp; item&apos;s
              accordion body.
            </AccordionBody>
          </AccordionItem>
        ))}
...
const AlwaysOpenAccordion = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Omit the <code>data-bs-parent</code> attribute on each <code>.accordion-collapse</code> to
