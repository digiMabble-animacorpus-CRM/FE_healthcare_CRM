    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          below, with optional display utilities. We hide them initially with <code>.d-none</code>{' '}
          and bring them back on medium-sized devices with <code>.d-md-block</code>.
        </>
      }
    >
      {/* <Row> */}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          instead of a slide. Depending on your carousel content (e.g., text only slides), you may
          want to add <code>.bg-body</code> or some custom CSS to the <code>.carousel-item</code>s
...
const IndividualInterval = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Add <code>data-bs-interval=&ldquo;</code> to a <code>.carousel-item</code> to change the
...
const DisableTouchCarousel = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Carousels support swiping left/right on touchscreen devices to move between slides. This
          can be disabled using the <code>data-bs-touch</code> attribute. The example below also
          does not includethe <code>data-bs-ride</code> attribute so it doesn’t autoplay.
        </>
      }
    >
      {/* <Row> */}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          that customize the<code>color</code> and <code>background-color</code>.
        </>
      }
    >
      {/* <Row> */}
