    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          Titles are set via <code>data-bs-title</code> and body content is set via{' '}
...
const CustomPopovers = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          ou can customize the appearance of popovers using CSS variables. We set a custom class
          with <code>data-bs-custom-class=&quot;primary-popover&quot;</code> to scope our custom
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          trigger the popover from a wrapper <code>&lt;div&gt;</code> or <code>&lt;span&gt;</code>{' '}
          and override the <code>pointer-events</code> on the disabled element.
        </>
      }
    >
