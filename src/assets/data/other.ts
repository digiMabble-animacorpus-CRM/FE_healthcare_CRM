...
export const staffData: StaffType[] = [
  {
    ...
    dob: "1982-05-17",
    description: "Experienced general practitioner with 15 years in family medicine.",
    role: "Doctor",
    accessLevel: "branch-admin",
    branches: [
      { name: "Anima Corpus Namur", isPrimary: true },
    ],
    selectedBranch: "Anima Corpus Namur",
    ...
    status: "active",
    permissions: [
      { key: "view-patients", enabled: true },
      { key: "edit-patients", enabled: true },
      { key: "prescribe-meds", enabled: true },
      { key: "admin-access", enabled: true },
    ],
    loginDetails: {
      otpVerified: true,
...

  {
    ...
    accessLevel: "staff",
    branches: [
      { name: "Gembloux - Orneau", isPrimary: true },
    ],
    selectedBranch: "Gembloux - Orneau",
    experience: "8 years",
    ...
    permissions: [
      { key: "view-patients", enabled: true },
      { key: "manage-appointments", enabled: true },
    ],
    loginDetails: {
      otpVerified: true,
...

  {
    ...
    selectedBranch: "Gembloux - Tout Vent",
    status: "active",
    permissions: [
      { key: "admin-access", enabled: true },
      { key: "manage-inventory", enabled: true },
      { key: "access-billing", enabled: true },
    ],
    loginDetails: {
      otpVerified: true,
      loginCount: 65,
...

  {
    ...
    role: "LabTechnician",
    accessLevel: "staff",
    branches: [{ name: "Anima Corpus Namur", isPrimary: true }],
    selectedBranch: "Anima Corpus Namur",
...

  {
    ...
    role: "Receptionist",
    accessLevel: "staff",
    branches: [{ name: "Gembloux - Tout Vent", isPrimary: true }],
    selectedBranch: "Gembloux - Tout Vent",
    experience: "3 years",
    status: "active",
    permissions: [
